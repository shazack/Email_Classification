...
class Perceptrontest:
    ...
    def read_model(self):
        prior_list = []
        with open("per_model-2.txt", "r", encoding="latin1") as file:
    ...
    def test_model(self):
        ...
        # print(self.result)
        with open("per_output.txt-2", "w", encoding="latin1") as f:
...
if __name__ == "__main__":
    ...
    d = "/Users/nisharazack/Documents/NLP/Assignment2/Spam or Ham/dev"
...
print(accuracy)
print("Avg Perceptron Recall Spam")
respam = countspam / spamtot
print(respam)
print("Avg Perceptron Recall Ham")
reham = countham / hamtot
print(reham)
print("Avg Perceptron Precision Spam")
prespam = countspam / bespam
print(prespam)
print("Avg Perceptron Precision Ham")
preham = countham / beham
print(preham)
print("Avg Perceptron F1 score Spam")
f1spam = (2 * prespam * respam) / (prespam + respam)
print(f1spam)
print("Avg Perceptron F1 score Ham")
